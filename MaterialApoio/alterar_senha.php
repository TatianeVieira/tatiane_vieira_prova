...
//garante q o usuario esteja logado
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if($nova_senha !== $confirmar_senha) {
        ...
        echo "<script>alert('As senhas deve ter pelo menos 8 caracteres!');</script>";
...
<body>
    <h2>Alterar Senha</h2>
    <p>Olá, <strong><?php echo $_SESSION['usuario'];?></strong>.Digite sua npva senha abaixo</p>
